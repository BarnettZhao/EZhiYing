...
public class ChannelUtil {
    ...
    private static String getChannelFromApk(Context context, String channelKey) {
        ...
        try {
            ...
            while (entries.hasMoreElements()) {
                ...
                LogUtil.d(TAG, "APK entry name --------> " + entryName);
    ...
    private static void saveChannelInSP(Context context, String channel) {
        PreferencesUtils.putString(context, PREF_KEY_CHANNEL, channel);
        PreferencesUtils.putInt(context, PREF_KEY_CHANNEL_VERSION, getVersionCode(context));
    }
    ...
    private static String getChannelFromSP(Context context) {
        ...
        int versionCodeSaved = PreferencesUtils.getInt(context, PREF_KEY_CHANNEL_VERSION, -1);
        ...
        return PreferencesUtils.getString(context, PREF_KEY_CHANNEL, "");
    }
